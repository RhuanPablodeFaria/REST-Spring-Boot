...
import com.mballem.demoparkpi.jwt.JwtToken;
import com.mballem.demoparkpi.jwt.JwtUserDetailsService;
import com.mballem.demoparkpi.web.dto.UsuarioLoginDto;
...
public class AutenticacacaoController {
    ...
    public ResponseEntity<?> autenticar(@RequestBody @Valid UsuarioLoginDto dto, HttpServletRequest request){
        ...
        try {
            ...
            log.warn("Bad Credentails from username '{}'",dto.getUsername());
        }
