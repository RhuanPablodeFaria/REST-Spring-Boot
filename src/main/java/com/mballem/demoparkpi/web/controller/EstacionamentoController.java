...
import com.mballem.demoparkpi.service.ClienteVagaService;
import com.mballem.demoparkpi.service.EstacionamentoService;
import com.mballem.demoparkpi.service.JasperService;
...
import com.mballem.demoparkpi.web.dto.mapper.ClienteVagaMapper;
...
public class EstacionamentoController {
    ...
    @PostMapping(path = "/check-in", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(path = "/check-in/{recibo}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(path = "/check-out/{recibo}", produces = MediaType.APPLICATION_JSON_VALUE)
    @PreAuthorize("hasRole('ADMIN')")
